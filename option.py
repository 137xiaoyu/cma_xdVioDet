...
parser.add_argument('--model-name', default='xd_a2v_3', help='name to save model')
# parser.add_argument('--ckpt', default='', type=str, help='ckpt for pretrained model')
parser.add_argument('--ckpt', default='./ckpt/xd_a2v_2_8_82.210.pkl', type=str, help='ckpt for pretrained model')
# parser.add_argument('--ckpt', default='./ckpt/xd_a2v_3_18_81.607.pkl', type=str, help='ckpt for pretrained model')
